...
namespace GTypes {
class Triangle : public LinePrimitive {

public:
  POINT_EGDE_3D v[3]; /*the original coordinates of the triangle, v0, v1, v2 in
  ...
  void setTexCoord(int ind,
                   POINT_EGDE_2D uv); /*set i-th vertex texture coordinate*/
  void setTexture(const Texture &texture) { tex = &texture; }
